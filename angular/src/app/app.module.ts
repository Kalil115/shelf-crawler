...
const routes: Routes = [
  ...
  {path:'shelf/dashboard', component: DashboardComponent},
  {path:'shelf/bookshelf', component:BookshelfComponent},
  {path:'shelf/movieshelf', component:MovieshelfComponent},
  {path:'shelf/tvshelf', component:TvshelfComponent},
  {path:'shelf/gameshelf', component:GameshelfComponent},
